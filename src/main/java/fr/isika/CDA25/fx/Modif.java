...
public class Modif extends StackPane {
	...
	public TextField txtUNom = new TextField();
	...
	public Modif() {
		...
		this.myVB = new VBox();
		this.labelTitre = new Label("Veuillez saisir les nouvex données");
		this.myGridPane = new GridPane();
		this.labelNom = new Label("Nom :");
		this.txtUNom = new TextField();
