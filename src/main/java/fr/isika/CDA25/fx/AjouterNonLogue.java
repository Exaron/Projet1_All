...
public class AjouterNonLogue extends StackPane {
	...
	public Button validerAjoutNL = new Button("Valider");
	public Button retourAjoutNonLogue = new Button ("Retour");
	private Label erreur;

	public AjouterNonLogue() {
		super();
		...
		this.validerAjoutNL = new Button("Valider");
		this.retourAjoutNonLogue = new Button("Retour");
		...
		myVB.getChildren().add(validerAjoutNL);
		myVB.getChildren().add(retourAjoutNonLogue);
	...
	public Button getValiderAjoutNL() {
		return validerAjoutNL;
	}
	public Button getRetourAjoutNonLogue() {
		return retourAjoutNonLogue;
	}
